...
from requests_auth import EntraIDDeviceCode, TimeoutOccurred
...
def test_oauth2_device_code_flow_uses_provided_session(
    ...
    auth = requests_auth.EntraIDDeviceCode(
        "6d655498-2fe7-413e-9443-4f108184be38",
        client_id="0d15afb1-2e83-487f-9d5a-fdd241d03db2",
        session=session,
    )
    responses.post(
        "https://login.microsoftonline.com/6d655498-2fe7-413e-9443-4f108184be38/oauth2/v2.0/devicecode",
        json={
    ...
    responses.post(
        "https://login.microsoftonline.com/6d655498-2fe7-413e-9443-4f108184be38/oauth2/v2.0/token",
        json={
...
def test_oauth2_device_code_flow_token_custom_expiry(
    ...
    token_cache._add_token(
        key="ba2535d60bf38bde662eba49add795cc707c5f247b36d198fc98bc2dd82b9f1736ce63a27442ee4761982d739ab67b7ad92efec3dd8b04f613766904a0ad7e20",
        token="2YotnFZFEjr1zCsicMWpAA",
        expiry=requests_auth._oauth2.tokens._to_expiry(expires_in=29),
    )
    responses.get(
...
class TestPollingBehaviour:
    _tenant_id = "6d655498-2fe7-413e-9443-4f108184be38"
    _authorization_url = f"https://login.microsoftonline.com/{_tenant_id}/oauth2/v2.0/devicecode"
    ...
    def auth(self) -> tuple[EntraIDDeviceCode, str]:
        client_id = str(uuid.uuid4())
        return (
            requests_auth.EntraIDDeviceCode(
    ...
    def test_authorization_polls_expected_count(
        self, responses: RequestsMock, auth: EntraIDDeviceCode
    ) -> None:
        device_code_auth, client_id = auth
        self._configure_authorization_response(responses, client_id, 60, 5)
        responder = TokenResponder(responses, self._token_url, status_code=400)
